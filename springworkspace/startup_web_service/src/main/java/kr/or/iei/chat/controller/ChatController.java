...
@Controller // Spring MVC 컨트롤러임을 명시 (WebSocket 메시징에도 사용)
public class ChatController {
     ...
     */
    @MessageMapping("/chat/message") // 클라이언트가 "/pub/chat/message"로 메시지를 보낼 때 매핑
    ...
    // 이는 @RestController를 사용하는 별도의 컨트롤러가 될 수도 있습니다.
}
